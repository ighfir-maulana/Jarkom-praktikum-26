...
1.  Buka Wireshark dan klik 2 kali pada teks `Wi-Fi`.![alt text](../Assets/Week1-2.png)
2.  Otomatis akan merekam/menangkap lalu lintas data yang ada. Kalau tidak otomatis, klik tombol `Start` (ikon sirip hiu biru).![alt text](../Assets/Week1-3.png)
3.  Buka browser dan akses halaman: `http://gaia.cs.umass.edu/wireshark-labs/INTRO-wireshark-file1.html`.![alt text](../Assets/Week1-4.png)
> **Catatan:** Pastikan `http`, bukan `https`. Karena di beberapa *device* atau *browser* berubah secara otomatis.
4.  Kembali ke Wireshark dan ketik di kotak filter `http`.![alt text](../Assets/Week1-5.png)
5.  Cari dan klik pada data yang memiliki info `HTTP/1.1 200 OK (text/html)`.![alt text](../Assets/Week1-6.png)
> **Tips:** Kalau tidak muncul, coba gunakan *browser* lain atau me-*refresh*-nya secara berkala (cara *hard reset*: `ctrl+shift+r`)
6.  Cari dan klik di kotak kiri bawah yang bertuliskan `Line-based text data: text/html (3 lines)`.![alt text](../Assets/Week1-7.png)
7. Kamu akan melihat teks html yang ada pada website tersebut.![alt text](../Assets/Week1-8.png)
